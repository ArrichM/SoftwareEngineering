...
test_that("Test multiply_recursive()  Varying Growth",{
  ...
  expected <- c(10.8,11.124,11.90268,12.1407336,12.62636294) #manually calculated values. We lose first observation due to differentiation
